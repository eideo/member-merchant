...
import com.zlebank.zplatform.member.merchant.bean.Enterprises;
...
public class EnterpriseServiceImpl implements EnterpriseService {
   ...
   /* @Autowired
	...
	public String registerApply(EnterpriseBean enterpriseDeta) throws CreateMemberFailedException, InvalidMemberDataException {
		...
		try {
			//通过手机号查询是否绑定过会员
			MemberBean member = (MemberBean) memberService.getMemberByPhoneAndCoopInsti(enterpriseDeta.getCellPhoneNo(), coopInsti.getId());//getMemberByphone(enterpriseDeta.getCellPhoneNo());
			if(member!=null){
